  ...
  return (
    <div className="container mx-auto px-6 py-32 max-w-4xl space-y-16">
      ...
      >
        ...
        <h1 className="text-5xl font-serif italic">Shipping & Delivery</h1>
        <p className="text-xl text-foreground/60 font-serif leading-relaxed">Everything you need to know about how we deliver our Atlas botanical treasures to your doorstep.</p>
      </motion.div>

      <div className="grid gap-12">
        <section className="space-y-6">
            <h2 className="text-2xl font-serif italic text-primary">Domestic Shipping (Morocco)</h2>
            <div className="prose prose-slate max-w-none text-foreground/70 font-serif leading-relaxed space-y-4">
        ...
        <section className="space-y-6 p-10 bg-secondary/10 rounded-[2.5rem] border border-secondary">
             <h2 className="text-2xl font-serif italic">Need Help?</h2>
             <p className="text-foreground/70 font-serif">If you have any questions about your delivery or need to track an order, please contact our support team on WhatsApp or via email.</p>
             <div className="pt-4">
