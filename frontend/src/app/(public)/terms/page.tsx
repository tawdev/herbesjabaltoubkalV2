  ...
  return (
    <div className="container mx-auto px-6 py-32 max-w-4xl space-y-16">
      ...
      >
        ...
        <h1 className="text-5xl font-serif italic">Terms of Service</h1>
        <p className="text-xl text-foreground/60 font-serif leading-relaxed">By using our services, you agree to the following terms and conditions.</p>
      </motion.div>

      <div className="prose prose-slate max-w-none text-foreground/70 font-serif leading-relaxed space-y-10">
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">1. Product Information</h2>
        ...
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">2. Orders and Payment</h2>
        ...
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">3. Returns and Refunds</h2>
