  ...
  return (
    <div className="container mx-auto px-6 py-32 max-w-4xl space-y-16">
      ...
      >
        ...
        <h1 className="text-5xl font-serif italic">Privacy Policy</h1>
        <p className="text-xl text-foreground/60 font-serif leading-relaxed">At Herbes Jabal Toubkal, we respect your privacy and are committed to protecting your personal data.</p>
      </motion.div>

      <div className="prose prose-slate max-w-none text-foreground/70 font-serif leading-relaxed space-y-10">
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">1. Information We Collect</h2>
        ...
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">2. How We Use Your Data</h2>
        ...
        <section className="space-y-4">
            <h2 className="text-2xl font-serif italic text-primary">3. Data Security</h2>
